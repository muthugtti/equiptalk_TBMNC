              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    className="flex w-full rounded-lg text-gray-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-gray-300 dark:border-gray-600 bg-background-light dark:bg-gray-800/50 h-12 px-4 text-sm font-normal"
                  />
                </div>
