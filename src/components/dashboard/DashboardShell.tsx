        ...
        <div className="relative flex h-auto min-h-screen w-full flex-col">
            <div className="layout-container flex h-full grow flex-col">
                <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 dark:border-gray-700 bg-white dark:bg-background-dark/80 px-6 sm:px-10 py-3 sticky top-0 z-10 backdrop-blur-sm">
                    {/* Logo links to the operational overview (no longer a named nav tab). */}
                    <Link href="/dashboard" className="flex items-center gap-4 text-gray-800 dark:text-white">
                    ...
                    {/* Launch nav — Dashboard → Equipment → Incidents → Analytics. */}
                    <div className="hidden md:flex items-center gap-9">
                        <Link
                            href="/dashboard"
                            className={`text-sm font-medium ${pathname === '/dashboard' ? 'text-primary' : 'text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary'}`}
                        >
                            Dashboard
                        </Link>
                        <Link
                        ...
                        <Link
                            ...
                            className={`text-sm font-medium ${isActive('/dashboard/analytics') ? 'text-primary' : 'text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary'}`}
                        >
                            Analytics
                        </Link>
                    </div>
